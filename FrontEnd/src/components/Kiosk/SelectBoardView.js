...
const SelectBoardView = (props) => {
  ...
  return (
    <Div displayDiv="flex" fontSize="2.25rem" ml={30} mt={30} mb={30}>
      <Div fontSize="2rem" fontWeight={600} onClick={boardHandler}>
        Board
      </Div>
      <Div fontSize="2rem" ml="9px" fontWeight={600}>
        |
      </Div>
      <Div fontSize="2rem" ml="9px" fontWeight={600} onClick={calendarHandler}>
        Calender
      </Div>
    </Div>
  );
